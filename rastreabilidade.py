...
if telas == 'Apontamento de código SAP':
	...
	df_pal_sem_filtrado['data_estoque'] = df_pal_sem_filtrado['data_estoque'].astype('category')
	df_pal_sem_filtrado['data_estoque'] = df_pal_sem_filtrado['data_estoque'].str.sp.lit('.')[0]
