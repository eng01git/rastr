...
numero_bobina = st1.selectbox('Selecione a próxima bobina:', list((df_bobinas_disp['numero_OT'].astype(str) + '/ Data: ' + df_bobinas_disp['data'].astype(str) + ' /Tipo: ' + df_bobinas_disp['tipo_bobina'].astype(str))))
